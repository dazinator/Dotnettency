...
namespace Sample
{
    ...
    //{
    //    public Dictionary<int, Tenant> _tenants = new Dictionary<int, Tenant>();

    //    public TenantShellFactory()
    //    {
    //        _tenants = new Dictionary<int, Tenant>();
    //        _tenants.Add(5004, new Tenant(Guid.Parse("b17fcd22-0db1-47c0-9fef-1aa1cb09605e")) { Name = "Foo" });

    //        var barTenant = new Tenant(Guid.Parse("049c8cc4-3660-41c7-92f0-85430452be22")) { Name = "Bar" };
    //        _tenants.Add(5000, barTenant);
    //        _tenants.Add(5001, barTenant);
    //    }
