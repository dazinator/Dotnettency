...
namespace Dotnettency
{
    public static class MultitenancyServicesConfigurationShellItemExtensions
    {
        ...
        public static MultitenancyOptionsBuilder<TTenant> ConfigureTenantConfiguration<TTenant>(this MultitenancyOptionsBuilder<TTenant> optionsBuilder, Action<TenantShellItemBuilderContext<TTenant>, IConfigurationBuilder> configureItem)
             where TTenant : class
        {
